...
const PortFolio = () => {
  return (
    <section>
      <div>
        <div className="grid h-[calc(100vh-75px)] w-full grid-cols-[repeat(auto-fit,_minmax(75px,_1fr))] grid-rows-[repeat(auto-fit,_minmax(75px,_1fr))]">
          ...
          {/* <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-8">
            ...
            <p className="mb-6 mt-4 max-w-3xl text-center text-lg font-light text-neutral-500 md:text-xl">
              ...
              quisquam nemo excepturi officia necessitatibus veritatis enim
              ipsam! Laudantium, reiciendis officia!
            </p>
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col lg:flex-row items-center justify-center pt-10  max-w-[1500px] mx-auto">
            {/* left */}
            <div className="relative w-1/2 flex justify-center items-center h-full z-20">
              {/* front */}
              <div className="bg-gray-800 rounded-lg custom-shadow w-terminal  z-[15]">
                ...
                <div className="h-full px-6 py-[50px] pointer-events-auto">
